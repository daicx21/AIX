...
--sim-cycles=10000 --vcs-per-vnet=2 --injectionrate=" + str(i/10)
    print(s1)
    os.system(s1)
...
--topology=Mesh_XY --mesh-rows=8 \
--inj-vnet=0 --synthetic=uniform_random \
--sim-cycles=10000 --vcs-per-vnet=4 --injectionrate=" + str(i/10)
    print(s1)
    os.system(s1)
    s2 = 'grep "average_packet_latency" m5out/stats.txt | sed "s/system.ruby.network.average_packet_latency\s*/average_packet_latency = /"'
    cur = os.popen(s2)
...
--topology=Mesh_XY --mesh-rows=8 \
--inj-vnet=0 --synthetic=uniform_random \
--sim-cycles=10000 --vcs-per-vnet=8 --injectionrate=" + str(i/10)
    print(s1)
    os.system(s1)
    s2 = 'grep "average_packet_latency" m5out/stats.txt | sed "s/system.ruby.network.average_packet_latency\s*/average_packet_latency = /"'
    cur = os.popen(s2)
